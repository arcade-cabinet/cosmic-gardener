 ...
 *
 * Every procedural decision in cosmic-gardener — constellation layout,
 * star-seed placement, corruption wave timing, codename generation —
 * flows through this module. `Math.random()` is blocked in CI for any
 * file under `src/sim/`.
 *
 * Mirrors the shape used by bioluminescent-sea and (soon)
 * enchanted-forest so the three repos can share mental models.
 */
